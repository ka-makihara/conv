...
uint16_t	g_totalRx = 0;
uint16_t		g_rxBuff[128] = {0};
/* End user code. Do not edit comment generated here */
...
void R_RSPI0_Create(void)
{
    ...
    RSPI0.SPDCR.BYTE = _RSPI_ACCESS_WORD | _RSPI_FRAMES_1;
...
void R_RSPI1_Create(void)
{
    ...
    RSPI1.SPPCR.BYTE = _RSPI_MOSI_FIXING_PREV_TRANSFER | _RSPI_OUTPUT_PIN_CMOS | _RSPI_LOOPBACK_DISABLED | _RSPI_LOOPBACK2_DISABLED;
    RSPI1.SPBR = _RSPI1_DIVISOR;
    RSPI1.SPDCR.BYTE = _RSPI_ACCESS_WORD | _RSPI_FRAMES_1;
    ...
    RSPI1.SPCMD0.WORD = _RSPI_RSPCK_SAMPLING_ODD | _RSPI_RSPCK_POLARITY_LOW | _RSPI_BASE_BITRATE_8 | 
                        _RSPI_SIGNAL_ASSERT_SSL0 | _RSPI_SSL_KEEP_DISABLE | _RSPI_DATA_LENGTH_BITS_8 | 
                        _RSPI_MSB_FIRST | _RSPI_NEXT_ACCESS_DELAY_DISABLE | _RSPI_NEGATION_DELAY_DISABLE | 
                        _RSPI_RSPCK_DELAY_DISABLE;

    /* Set SPTI1 priority level */
    VIC.PRL85.LONG = _RSPI_PRIORITY_LEVEL0;
    
    /* Set SPRI1 priority level */
    VIC.PRL84.LONG = _RSPI_PRIORITY_LEVEL0;
    
    /* Set SPEI1 priority level */
    VIC.PRL86.LONG = _RSPI_PRIORITY_LEVEL0;
    
    /* Set SPII1 priority level */
    VIC.PRL87.LONG = _RSPI_PRIORITY_LEVEL0;
