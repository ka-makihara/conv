...
*/
#define _CGC_PLL1_CPUCKSEL_150        (0x00000000UL) /* 150 MHz */
#define _CGC_PLL1_CPUCKSEL_300        (0x00000001UL) /* 300 MHz */
#define _CGC_PLL1_CPUCKSEL_450        (0x00000002UL) /* 450 MHz */
#define _CGC_PLL1_CPUCKSEL_600        (0x00000003UL) /* 600 MHz */
