...
*******************************************************************************/
void R_CPG_WriteEnable(void) __attribute__ ((section (".loader_text2")));
void R_CPG_WriteDisable(void) __attribute__ ((section (".loader_text2")));
void R_CPG_PLL_Wait(void) __attribute__ ((section (".loader_text2")));
